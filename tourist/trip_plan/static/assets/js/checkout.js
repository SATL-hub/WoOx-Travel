// Select the form with the ID pymentForm and adds an event listener to listen for the submit event
...
document.getElementById("payform").addEventListener("submit", async function (event) {
    ...
    try {
        ...
        let response = await fetch(`/confirm/${transactionId}`, {
            method: "POST",
            body: formData
        });
